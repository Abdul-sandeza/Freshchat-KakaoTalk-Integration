...
import { a as handleKeyDown, h as hasSlot, r as renderHiddenField, d as debounce, e as cyclicDecrement, i as cyclicIncrement, j as isEqual } from './index-6b6fa50e.js';
import { F as FieldControl } from './field-control-54e4db3f.js';
import { T as TranslationController } from './Translation-e3b101d4.js';
...
const Select = class {
  ...
  renderButtonValue() {
    ...
    if (this.tagVariant === 'avatar' && ((_a = this.selectedOptionsState[0]) === null || _a === void 0 ? void 0 : _a.value)) {
      return (h("fw-tag", { class: 'display-tag', state: 'transparent', variant: 'avatar', graphicsProps: (_b = this.selectedOptionsState[0]) === null || _b === void 0 ? void 0 : _b.graphicsProps, text: (_c = this.selectedOptionsState[0]) === null || _c === void 0 ? void 0 : _c.text, subText: ((_d = this.selectedOptionsState[0]) === null || _d === void 0 ? void 0 : _d.subText)
  ...
  render() {
    ...
    return (h(FieldControl, { inputId: this.name, label: this.label, labelId: `${this.label}-${this.name}`, state: this.state, hintTextId: `hint-${this.name}`, hintText: this.hintText, hasHintTextSlot: this.hasHintTextSlot, errorTextId: `error-${this.name}`, errorText: this.errorText, hasErrorTextSlot: this.hasErrorTextSlot, warningTextId: `warning-${this.name}`, warningText: this.warningText, hasWarningTextSlot: this.hasWarningTextSlot, required: this.required }, h("div", { "aria-disabled": this.disabled, class: {
        ...
        : this.host.classList.value.includes('last')
          ...
          : '', "aria-disabled": this.disabled, disabled: this.disabled }, this.renderButtonValue()))) : (h(Fragment, null, h("div", { class: 'input-container-inner' }, this.multiple && (h("div", { class: 'tag-container', onFocus: this.focusOnTagContainer, ref: (tagContainer) => (this.tagContainer = tagContainer), onKeyDown: this.tagContainerKeyDown, tabIndex: -1 }, this.renderTags())), h("input", { ref: (selectInput) => (this.selectInput = selectInput), class: {
        'multiple-select': this.multiple,
      }, autoComplete: 'off', disabled: this.disabled, name: this.name, id: this.name, placeholder: this.valueExists() ? '' : this.placeholder || '', readOnly: this.readonly, required: this.required, type: this.type, value: '', "aria-autocomplete": 'list', "aria-activedescendant": this.focusedOptionId, onInput: () => this.onInput(), onFocus: (e) => this.innerOnFocus(e), onBlur: (e) => this.innerOnBlur(e), "aria-invalid": this.state === 'error', "aria-describedby": `hint-${this.name} error-${this.name}`, onPaste: (e) => this.onPaste(e), "aria-disabled": this.disabled })), this.isLoading ? (h("fw-spinner", { size: 'small' })) : (this.caret &&
      !this.readonly && (h("span", { class: {
