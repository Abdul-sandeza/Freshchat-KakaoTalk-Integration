...
const Datepicker = class {
  ...
  renderNavButtons() {
    return (index.h("div", { class: 'btns' }, index.h("div", { class: 'mdpch-button' }, index.h("div", { role: 'button', tabindex: '0', class: 'mdpchb-inner', onClick: () => this.setMonth(-1), onKeyDown: index$1.handleKeyDown(() => this.setMonth(-1)) }, index.h("span", { class: 'mdpchbi-left-arrow' }))), index.h("div", { class: 'mdpch-button-right' }, index.h("div", { role: 'button', tabindex: '0', class: 'mdpchb-inner', onClick: () => this.setMonth(1), onKeyDown: index$1.handleKeyDown(() => this.setMonth(1)) }, index.h("span", { class: 'mdpchbi-right-arrow' })))));
  }
