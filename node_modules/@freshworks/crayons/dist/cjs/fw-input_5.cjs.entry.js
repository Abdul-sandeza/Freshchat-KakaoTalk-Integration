...
const index$1 = require('./index-21de1832.js');
const fieldControl = require('./field-control-1653f500.js');
const Translation = require('./Translation-4d341fbd.js');
...
const ListOptions = class {
  ...
  fwSelectedHandler(selectedItem) {
    ...
    if (selected) {
      ...
      this.selectedOptionsState = this.multiple
        ? (_a = this.selectedOptionsState) === null || _a === void 0 ? void 0 : _a.filter((option) => option.value !== value)
        : [];
    }
  ...
  serializeData(dataSource) {
    return dataSource.map((option) => {
      ...
      const isDisabled = ((_b = (_a = this.selectedOptionsState) === null || _a === void 0 ? void 0 : _a.find((selected) => selected.value === option.value)) === null || _b === void 0 ? void 0 : _b.disabled) ||
        option.disabled ||
        this.disabled ||
        (this.multiple && ((_c = this.value) === null || _c === void 0 ? void 0 : _c.length) >= this.max);
  ...
  renderSelectOptions(options) {
    return options.map((option) => {
      ...
      return (index.h("fw-select-option", Object.assign({ id: `${this.host.id}-option-${option.value}`, key: option.value, allowSelect: this.allowSelect }, option, { disabled: isDisabled })));
    });
  }
  renderSearchInput() {
...
const Select = class {
  constructor(hostRef) {
    ...
    this.changeEmittable = () => !this.disabled && !this.readonly;
    this.innerOnFocus = (e) => {
        ...
        switch (ev.key) {
          ...
          case 'ArrowLeft':
            if (this.tagArrowKeyCounter - 1 >= 0) {
              ...
              if (!((_a = this.selectedOptionsState[this.tagArrowKeyCounter - 1]) === null || _a === void 0 ? void 0 : _a.disabled)) {
          ...
          case 'ArrowRight':
            this.tagArrowKeyCounter++;
            if (this.tagArrowKeyCounter >= ((_b = this.value) === null || _b === void 0 ? void 0 : _b.length)) {
    ...
    if (this.changeEmittable()) {
      switch (ev.key) {
        ...
        case 'Backspace':
          ...
          break;
        case 'ArrowLeft':
          if (this.multiple && ((_b = this.selectInput) === null || _b === void 0 ? void 0 : _b.value) === '') {
            this.focusOnTagContainer();
          }
          break;
        case 'Escape':
        ...
        case 'A':
          if (((ev.ctrlKey || ev.metaKey) && !this.searchValue) ||
            ...
            ev.preventDefault();
            ev.stopPropagation();
            (_c = this.tagContainer) === null || _c === void 0 ? void 0 : _c.focus();
            this.focusedValues = (_d = this.selectedOptionsState) === null || _d === void 0 ? void 0 : _d.reduce((arr, option, i) => (!option.disabled && arr.push(i), arr), []);
          }
          break;
      }
    }
      ...
      return (_a = this.selectedOptionsState) === null || _a === void 0 ? void 0 : _a.map((option, index$1) => {
        if (this.isValueEqual(this.value, option)) {
          const optionState = option.error || (this.variant === 'mail' && index$1 >= this.max)
            ? 'error'
            : 'normal';
          const className = this.disabled || option.disabled
            ? 'tag-disabled'
            : !this.readonly
              ? 'tag-clickable'
              : '';
          ...
          return (index.h("fw-tag", Object.assign({ index: index$1, class: className, state: optionState, variant: this.tagVariant, graphicsProps: option.graphicsProps, disabled: this.disabled || this.readonly || option.disabled, value: option.value, focusable: false, closable: !this.disabled && !this.readonly && !option.disabled, isFocused: this.focusedValues.includes(index$1), onClick: (e) => this.onClickTag(e, index$1) }, displayAttributes)));
        }
      });
    }
  }
  renderButtonValue() {
    ...
    if (this.tagVariant === 'avatar' && ((_a = this.selectedOptionsState[0]) === null || _a === void 0 ? void 0 : _a.value)) {
      return (index.h("fw-tag", { class: 'display-tag', state: 'transparent', variant: 'avatar', graphicsProps: (_b = this.selectedOptionsState[0]) === null || _b === void 0 ? void 0 : _b.graphicsProps, text: (_c = this.selectedOptionsState[0]) === null || _c === void 0 ? void 0 : _c.text, subText: ((_d = this.selectedOptionsState[0]) === null || _d === void 0 ? void 0 : _d.subText)
          ? `<${(_e = this.selectedOptionsState[0]) === null || _e === void 0 ? void 0 : _e.subText}>`
          : '', disabled: (_f = this.selectedOptionsState[0]) === null || _f === void 0 ? void 0 : _f.disabled, value: (_g = this.selectedOptionsState[0]) === null || _g === void 0 ? void 0 : _g.value, focusable: false, closable: false, showEllipsisOnOverflow: true }));
    }
    else {
      return this.value;
    }
  ...
  componentWillLoad() {
    ...
    if (!this.multiple && this.value && ((_c = this.selectedOptions) === null || _c === void 0 ? void 0 : _c.length) === 0) {
      this.selectedOptionsState = (_d = this.dataSource) === null || _d === void 0 ? void 0 : _d.filter((option) => this.value === option.value);
    }
  ...
  render() {
    ...
    return (index.h(fieldControl.FieldControl, { inputId: this.name, label: this.label, labelId: `${this.label}-${this.name}`, state: this.state, hintTextId: `hint-${this.name}`, hintText: this.hintText, hasHintTextSlot: this.hasHintTextSlot, errorTextId: `error-${this.name}`, errorText: this.errorText, hasErrorTextSlot: this.hasErrorTextSlot, warningTextId: `warning-${this.name}`, warningText: this.warningText, hasWarningTextSlot: this.hasWarningTextSlot, required: this.required }, index.h("div", { "aria-disabled": this.disabled, class: {
      ...
      }, onClick: () => this.innerOnClick(), onKeyDown: index$1.handleKeyDown(this.innerOnClick, true) }, this.variant === 'button' ? (this.readonly ? (this.renderButtonValue()) : (index.h("fw-button", { style: { '--fw-button-label-vertical-padding': '7px' }, "show-caret-icon": true, id: `${this.hostId}-btn`, color: this.tagVariant === 'avatar' ? 'text' : 'secondary', class: this.host.classList.value.includes('first')
        ? 'fw-button-group__button--first'
        : this.host.classList.value.includes('last')
          ? 'fw-button-group__button--last'
          : '', "aria-disabled": this.disabled, disabled: this.disabled }, this.renderButtonValue()))) : (index.h(index.Fragment, null, index.h("div", { class: 'input-container-inner' }, this.multiple && (index.h("div", { class: 'tag-container', onFocus: this.focusOnTagContainer, ref: (tagContainer) => (this.tagContainer = tagContainer), onKeyDown: this.tagContainerKeyDown, tabIndex: -1 }, this.renderTags())), index.h("input", { ref: (selectInput) => (this.selectInput = selectInput), class: {
        'multiple-select': this.multiple,
      }, autoComplete: 'off', disabled: this.disabled, name: this.name, id: this.name, placeholder: this.valueExists() ? '' : this.placeholder || '', readOnly: this.readonly, required: this.required, type: this.type, value: '', "aria-autocomplete": 'list', "aria-activedescendant": this.focusedOptionId, onInput: () => this.onInput(), onFocus: (e) => this.innerOnFocus(e), onBlur: (e) => this.innerOnBlur(e), "aria-invalid": this.state === 'error', "aria-describedby": `hint-${this.name} error-${this.name}`, onPaste: (e) => this.onPaste(e), "aria-disabled": this.disabled })), this.isLoading ? (index.h("fw-spinner", { size: 'small' })) : (this.caret &&
      !this.readonly && (index.h("span", { class: {
