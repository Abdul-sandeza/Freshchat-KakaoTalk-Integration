...
const Form = class {
  ...
  render() {
    ...
    return (index.h("form", Object.assign({ id: `form-${this.formId}` }, utils.formProps), this.formSchema && Object.keys(this.formSchema).length > 0 ? ((_b = (_a = this.formSchema) === null || _a === void 0 ? void 0 : _a.fields) === null || _b === void 0 ? void 0 : _b.sort((a, b) => a.position - b.position).map((field) => {
      return (index.h("fw-form-control", { key: field.name, name: field.name, type: field.type, label: field.label, required: field.required, hint: field.hint, placeholder: field.placeholder, choices: field.choices, fieldProps: field, controlProps: utils }));
    })) : (index.h("slot", { onSlotchange: () => this.handleSlotChange() }))));
  }
  get el() { return index.getElement(this); }
  static get watchers() { return {
    "formSchema": ["formSchemaHandler"],
