...
function __variableDynamicImportRuntime0__(path) {
  switch (path) {
    case '../i18n/ar-SA.json': return Promise.resolve().then(function () { return require('./ar-SA-a77e1077-ffb9705e.js'); });
    case '../i18n/bg-BG.json': return Promise.resolve().then(function () { return require('./bg-BG-954648df-8daedacc.js'); });
    case '../i18n/bs-BA.json': return Promise.resolve().then(function () { return require('./bs-BA-28d26fdb-f7254042.js'); });
    case '../i18n/ca-ES.json': return Promise.resolve().then(function () { return require('./ca-ES-7b6b372a-aaeeaac6.js'); });
    case '../i18n/cs-CZ.json': return Promise.resolve().then(function () { return require('./cs-CZ-06ff7523-fc5e99e6.js'); });
    case '../i18n/da-DK.json': return Promise.resolve().then(function () { return require('./da-DK-afc6a974-1dd68585.js'); });
    case '../i18n/de-DE.json': return Promise.resolve().then(function () { return require('./de-DE-71237f38-228c5087.js'); });
    case '../i18n/el-GR.json': return Promise.resolve().then(function () { return require('./el-GR-870735a8-c566bf23.js'); });
    case '../i18n/en-US.json': return Promise.resolve().then(function () { return require('./en-US-0df2b41f-26a0a426.js'); });
    case '../i18n/es-ES.json': return Promise.resolve().then(function () { return require('./es-ES-d48de154-3eb4af29.js'); });
    case '../i18n/es-MX.json': return Promise.resolve().then(function () { return require('./es-MX-b9e99a7d-d19578e7.js'); });
    case '../i18n/et-EE.json': return Promise.resolve().then(function () { return require('./et-EE-0315cf0c-161df738.js'); });
    case '../i18n/fi-FI.json': return Promise.resolve().then(function () { return require('./fi-FI-2a107308-8cb6d188.js'); });
    case '../i18n/fil-PH.json': return Promise.resolve().then(function () { return require('./fil-PH-43d215e7-5c1e5cb2.js'); });
    case '../i18n/fr-FR.json': return Promise.resolve().then(function () { return require('./fr-FR-0a7a9a3e-2bf7925a.js'); });
    case '../i18n/he-IL.json': return Promise.resolve().then(function () { return require('./he-IL-ed63638a-4a53e965.js'); });
    case '../i18n/hr-HR.json': return Promise.resolve().then(function () { return require('./hr-HR-8a9dde7e-99936813.js'); });
    case '../i18n/hu-HU.json': return Promise.resolve().then(function () { return require('./hu-HU-5a8f8ec8-d05d9457.js'); });
    case '../i18n/id-ID.json': return Promise.resolve().then(function () { return require('./id-ID-800ade62-d76d6bb6.js'); });
    case '../i18n/is-IS.json': return Promise.resolve().then(function () { return require('./is-IS-ba8fce50-07ab0615.js'); });
    case '../i18n/it-IT.json': return Promise.resolve().then(function () { return require('./it-IT-41f83f62-feb60a98.js'); });
    case '../i18n/ja-JP.json': return Promise.resolve().then(function () { return require('./ja-JP-6e2d725f-b1009a28.js'); });
    case '../i18n/ko-KR.json': return Promise.resolve().then(function () { return require('./ko-KR-c822a897-303fa1a6.js'); });
    case '../i18n/lt-LT.json': return Promise.resolve().then(function () { return require('./lt-LT-4080c81f-49a6d0ae.js'); });
    case '../i18n/lv-LV.json': return Promise.resolve().then(function () { return require('./lv-LV-e8264ff6-546df556.js'); });
    case '../i18n/nl-NL.json': return Promise.resolve().then(function () { return require('./nl-NL-2a3ab0eb-ad7e1782.js'); });
    case '../i18n/no-NO.json': return Promise.resolve().then(function () { return require('./no-NO-db397dc9-30f12272.js'); });
    case '../i18n/pl-PL.json': return Promise.resolve().then(function () { return require('./pl-PL-5c092d18-692fd337.js'); });
    case '../i18n/pt-BR.json': return Promise.resolve().then(function () { return require('./pt-BR-67337dd4-0d3eb2bd.js'); });
    case '../i18n/pt-PT.json': return Promise.resolve().then(function () { return require('./pt-PT-d4f94a90-23a2bfab.js'); });
    case '../i18n/ro-RO.json': return Promise.resolve().then(function () { return require('./ro-RO-dbd93d05-2dfad797.js'); });
    case '../i18n/ru-RU.json': return Promise.resolve().then(function () { return require('./ru-RU-df4b4e72-e4d4a458.js'); });
    case '../i18n/sk-SK.json': return Promise.resolve().then(function () { return require('./sk-SK-ebb966eb-668e65cf.js'); });
    case '../i18n/sl-SI.json': return Promise.resolve().then(function () { return require('./sl-SI-46d08e5a-21662053.js'); });
    case '../i18n/sr-SP.json': return Promise.resolve().then(function () { return require('./sr-SP-4c215794-846c4327.js'); });
    case '../i18n/sv-SE.json': return Promise.resolve().then(function () { return require('./sv-SE-f7e7e8c3-eb073b4f.js'); });
    case '../i18n/th-TH.json': return Promise.resolve().then(function () { return require('./th-TH-24893eff-27b59c6b.js'); });
    case '../i18n/tr-TR.json': return Promise.resolve().then(function () { return require('./tr-TR-4ac1358a-8a9dae60.js'); });
    case '../i18n/uk-UA.json': return Promise.resolve().then(function () { return require('./uk-UA-9e102214-58906c43.js'); });
    case '../i18n/vi-VN.json': return Promise.resolve().then(function () { return require('./vi-VN-b69b4061-8f4f95ce.js'); });
    case '../i18n/zh-CN.json': return Promise.resolve().then(function () { return require('./zh-CN-746a6138-07235092.js'); });
    case '../i18n/zh-TW.json': return Promise.resolve().then(function () { return require('./zh-TW-f5571524-a1e2681e.js'); });
    default: return new Promise(function(resolve, reject) {
      (typeof queueMicrotask === 'function' ? queueMicrotask : setTimeout)(
        reject.bind(null, new Error("Unknown variable dynamic import: " + path))
      );
