import { Component, Prop, State, Event, Watch, h, Method, } from '@stencil/core';
    ...
    return (h("div", { class: 'dropzone', key: 'dropzone', tabIndex: 0, onDrop: (event) => this.dropHandler(event), onDragOver: (event) => event.preventDefault(), onClick: () => this.fileInputElement.click(), onKeyUp: (event) => {
      ...
      h("div", { class: 'dropzone-center' },
        h("div", { class: 'drop-clickable' },
          ...
          h("div", { class: 'drop-clickable-text' },
            h("input", Object.assign({ type: 'file', hidden: true }, multipleFiles, { style: { display: 'none' }, onChange: (ev) => this.fileHandler(ev), ref: (el) => (this.fileInputElement = el) })),
